...
prediction_prob_eval <- predict(model1, clean_dataset_of_diabetes_evaluation, type = "prob")
prediction_class_eval <- predict(model1, clean_dataset_of_diabetes_evaluation, type = "class")
